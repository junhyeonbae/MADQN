...
parser.add_argument('--predator1_view_range',type=int, default=1)
parser.add_argument('--predator2_view_range',type=int, default=4)
parser.add_argument('--n_predator1',type=int, default=6)
parser.add_argument('--n_predator2',type=int, default=6)
parser.add_argument('--n_prey',type=int, default=24)
