        ...
        for agent in env.agent_iter():
            ...
            if (((iteration_number) % (args.n_predator1 + args.n_predator2 + args.n_prey)) == 0) and (iteration_number > 0):
                ...
                if step_idx != args.max_update_steps :
                    ...
                    madqn.avg_tag_into_deque_pred1((madqn.step_tag_count_pred[0]) / n_predator1)
                    ...
                    madqn.avg_tag_into_deque_pred2((madqn.step_tag_count_pred[1]) / n_predator2)
            ...
            if agent[:8] == "predator":
                ...
                if agent[9] == "1":
                    ...
                    madqn.put_dist(dist_list) #현재 agent가 해당하는 팀의 summation_team_dist 에 prey들과의 거리 리스트를 concat한다. 그럼, 모든 step 이 끝났을때 팀 전체의 prey까지의 거리의 평균을 구할 수 있다.
